...
@register_collator("detcon_collator")
def detcon_collator(batch):
    """
    This collator is used in DetCon approach.
    ...
    output_data, output_label, output_data_valid, output_data_idx,output_mask = [], [], [], [], []
    for pos in range(num_positives):
        for idx in range(num_images):
            ...
            output_mask.append(mask[idx][pos])
            
    #import ipdb;ipdb.set_trace()       
    binary_mask = convert_binary_mask(torch.stack(output_mask))
